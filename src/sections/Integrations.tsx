            ...
            <div className="container">
                <div className="grid lg:grid-cols-2 items-center lg:gap-16">
                    <div>
                        ...
                        <p className="text-white/50 mt-4 text-lg">Layers seriously connects with your favorite tools, making it easy to streamline your workflows and collaborate across platforms.</p>
                    </div>
                    <div>
                        <div className="h-[400px] lg:h-[800px] mt-8 lg:mt-0 grid md:grid-cols-2 gap-4 overflow-hidden [mask-image: linear-gradient(to bottom, transparent, black_10, black_90, transparent)]">
