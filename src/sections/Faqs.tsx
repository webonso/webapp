    ...
    return (
        <section className="py-24">
            <div className="container">
                ...
                <h2 className="text-6xl font-medium mt-6 text-center max-w-xl mx-auto">Questions? We&apos;ve got{" "}
                    <span className="text-lime-400">answers</span>
                </h2>
                <div className="mt-12 flex flex-col gap-6 max-w-xl mx-auto">
                    {faqs.map((faq, faqIndex) => (
                        <div key={faq.answer} className="bg-neutral-900 rounded-2xl border border-white/10 p-6">
